...
My goal is to build a \emph{full spectrum programming language} that accomodates degrees of safety, ranging from the high-assurance required for kernel software to powerful flexibility of scripts.
